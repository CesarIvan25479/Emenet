                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                <a href="../imagenesOrden/orden/<?=$datosImagenes['ImgOrden']?>" data-toggle="lightbox" data-title="Orden" data-gallery="gallery">
                                    <img src="../imagenesOrden/orden/<?=$datosImagenes['ImgOrden']?>" class="img-fluid mb-2" alt="black sample"/>
                                </a>
                            </div>
                            ...
                            <div class="col-sm-2">
                                <a href="../imagenesOrden/credencial/<?=$datosImagenes['ImgCredencial']?>" data-toggle="lightbox" data-title="Credencial" data-gallery="gallery">
                                    <img src="../imagenesOrden/credencial/<?=$datosImagenes['ImgCredencial']?>" class="img-fluid mb-2" alt="black sample"/>
                                </a>
                            </div>
                            <?php endif;?>
                            <div class="col-sm-2">
                                <a href="../imagenesOrden/compromiso/<?=$datosImagenes['ImgCompromiso']?>" data-toggle="lightbox" data-title="Compromiso" data-gallery="gallery">
                                    <img src="../imagenesOrden/compromiso/<?=$datosImagenes['ImgCompromiso']?>" class="img-fluid mb-2" alt="black sample"/>
                                </a>
                            </div>
                        </div>
                    </div>
